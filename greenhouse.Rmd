...
We could use our findings of how the wealthiest counties emit the most, tying it with a global story on how the world's richest 1% emit more than two thirds of the world's poorest. This could be a local angle on that story, of how minorities and those with lower incomes suffer more fromt the efefcts of pollution and climate change but emit the least.
